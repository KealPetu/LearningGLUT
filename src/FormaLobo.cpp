...
void generarPoligonos(int a, int b, int c);
void dibujarNariz();
void dibujarOjos();
...
void display(){
    ...
    glLineWidth(5.0f);
    // draw
    generarPoligonos(0, 1, 23);
    generarPoligonos(1, 19, 23);
    generarPoligonos(1, 2, 19);
    generarPoligonos(2, 3, 4);
    generarPoligonos(2, 4, 19);
    generarPoligonos(4, 5, 19);
    generarPoligonos(5, 6, 19);
    generarPoligonos(23, 20, 19);
    generarPoligonos(20, 19, 21);
    generarPoligonos(19, 21, 6);
    generarPoligonos(21, 6, 7);
    generarPoligonos(20, 13, 21);
    generarPoligonos(23, 20, 12);
    generarPoligonos(23, 12, 24);
    generarPoligonos(12, 13, 20);
    generarPoligonos(12, 14, 24);
    generarPoligonos(24, 14, 22);
    generarPoligonos(14, 13, 22);
    generarPoligonos(13, 21, 22);
    generarPoligonos(7, 8, 21);
    generarPoligonos(8, 21, 22);
    generarPoligonos(8, 9, 22);
    generarPoligonos(9, 16, 22);
    generarPoligonos(9, 10, 16);
    generarPoligonos(10, 16, 17);
    generarPoligonos(10, 17, 18);
    generarPoligonos(10, 11, 18);
    generarPoligonos(15, 16, 22);
    generarPoligonos(15, 22, 24);
